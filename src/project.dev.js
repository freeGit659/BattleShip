window.__require = function e(t, n, r) {
  ...
  loginManager: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      loadGameAssets: function loadGameAssets() {
        var _this = this;
        cc.tween(this.loadingWaves).to(2, {
          y: this.yEnd - 20
        }).start();
        cc.director.preloadScene("mainScene", function(completedCount, totalCount, item) {
          var progress = completedCount / totalCount * 100;
          _this.percentLabel.string = progress.toFixed() + "%";
        }, function(error) {
          error ? console.error(error) : cc.director.loadScene("mainScene");
        });
      }
    });
    cc._RF.pop();
